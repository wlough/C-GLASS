...
private:
  ...
  SpeciesBase *pc_species_ =
      nullptr;  // The species that the PointCover corresponds to
  ...
  double
      spacing_; // The seperation between receptors on object for grid insertion
  int n_members_pc_; // Number of members in pc_species_
  double
      s_; // The position (length) along object of the receptor (for species-PointCover)
