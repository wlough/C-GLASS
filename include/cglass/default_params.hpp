  ...
  default_config["centrosome"]["filament_species_name"] = "NULL";
  default_config["centrosome"]["num_anchors_ea"] = "0";
  default_config["centrosome"]["attach_diameter"] = "0.0";
  default_config["centrosome"]["diffusion"] = "0.0";
  default_config["centrosome"]["wall_f0"] = "0.0";
  default_config["centrosome"]["wall_ne"] = "0.0";
  default_config["centrosome"]["wall_kr"] = "0.0";
  default_config["chromosome"]["n_attached"] = "0.0";
  default_config["chromosome"]["translational_noise"] = "0.0";
  default_config["chromosome"]["rotational_noise"] = "0.0";
  default_config["chromosome"]["zero_temperature"] = "false";
  ...
  default_config["membrane"]["bending_modulus"] = "4e-3";
  default_config["membrane"]["spontaneous_curvature"] = "0.0";
  default_config["membrane"]["splay_modulus"] = "0.0";
  default_config["membrane"]["dimensionless_tether_repulsive_singularity"] = "0.4";
  default_config["membrane"]["dimensionless_tether_repulsive_onset"] = "0.8";
  default_config["membrane"]["dimensionless_tether_attractive_onset"] = "1.2";
  default_config["membrane"]["dimensionless_tether_attractive_singularity"] = "1.6";
  default_config["membrane"]["tether_stiffness"] = "0.015625";
  default_config["membrane"]["fix_target_face_area"] = "true";
  default_config["membrane"]["area_stiffness"] = "100.0";
  default_config["membrane"]["fix_target_volume"] = "true";
  default_config["membrane"]["volume_stiffness"] = "3200.0";
  default_config["membrane"]["node_drag_coefficient"] = "1.0";
  default_config["membrane"]["kBT"] = "2e-4";
  default_config["membrane"]["enable_flipping"] = "true";
  ...
  default_config["movie_directory"] = "output/temp_images";
  ...
  default_config["mesh_membrane"] = "false";
  default_config["mesh_datapoints"] = "10000";
  default_config["mesh_steps_per_datapoint"] = "10";
  default_config["mesh_shrink_rate"] = "0.0";
  default_config["membrane_tether_stiffness"] = "0.0";
  default_config["membrane_bending_modulus"] = "0.0";
  default_config["membrane_area_reg_stiffness"] = "0.0";
  default_config["membrane_volume_reg_stiffness"] = "0.0";
  default_config["n_subdivisions"] = "0";
  default_config["node_diameter"] = "0.0";
  default_config["membrane_node_drag_coefficient"] = "0.0";
  default_config["draw_centroid"] = "false";
  default_config["draw_mindist"] = "false";
  default_config["enable_flipping"] = "false";
  default_config["make_a_movie"] = "false";
  default_config["membrane_ply_path"] = "data/cglass_ply/unit_sphere_005120.ply";
  default_config["membrane_scale_to_system_radius"] = "false";
  default_config["membrane_tether_repulsive_singularity"] = "0.1";
  default_config["membrane_tether_repulsive_onset"] = "0.8";
  default_config["membrane_tether_attractive_onset"] = "1.2";
  default_config["membrane_tether_attractive_singularity"] = "3.3";
