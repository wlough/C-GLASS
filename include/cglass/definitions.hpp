...
BETTER_ENUM(species_id, unsigned char, membrane, br_bead, filament,
            rigid_filament, spherocylinder, spindle, crosslink, receptor,
            point_cover, centrosome, chromosome, none);
