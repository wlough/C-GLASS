#ifndef _CGLASS_FILAMENT_INCOMING_OUTGOING_ANGLE_ANALYSIS_H_
#define _CGLASS_FILAMENT_INCOMING_OUTGOING_ANGLE_ANALYSIS_H_
...
#endif // _CGLASS_FILAMENT_INCOMING_OUTGOING_ANGLE_ANALYSIS_H_
