#ifndef _CGLASS_FILAMENT_CURVATURE_CLUSTER_ANALYSIS_H_
#define _CGLASS_FILAMENT_CURVATURE_CLUSTER_ANALYSIS_H_
...
#endif // _CGLASS_FILAMENT_CURVATURE_CLUSTER_ANALYSIS_H_
